...
public class BanEntry {
	...
	public BanEntry(String entity, String server, String reason, String staff, Timestamp beginDate, Timestamp endDate,
			Timestamp unbanDate, String unbanReason, String unbanStaff, boolean active) {
		super();
		this.entity = entity;
		this.server = server;
		this.reason = reason;
