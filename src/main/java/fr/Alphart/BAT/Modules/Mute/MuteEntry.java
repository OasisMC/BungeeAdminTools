...
public class MuteEntry {
	...
	public MuteEntry(String entity, String server, String reason, String staff, Timestamp beginDate, Timestamp endDate,
			Timestamp unmuteDate, String unmuteReason, String unmuteStaff, boolean active) {
		super();
		this.entity = entity;
		this.server = server;
		this.reason = reason;
