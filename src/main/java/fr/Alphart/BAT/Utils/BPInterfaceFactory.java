...
public class BPInterfaceFactory{
	...
	static class BungeePermsV3 implements PermissionProvider{
		...
		public BungeePermsV3(net.alpenblock.bungeeperms.platform.bungee.BungeePlugin bpPlugin) {
	...
	static class BungeePermsV2 implements PermissionProvider{
		...
		public BungeePermsV2(net.alpenblock.bungeeperms.BungeePerms bpPlugin) {
			this.bpPlugin = bpPlugin;
		}
